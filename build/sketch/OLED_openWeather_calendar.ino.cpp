#line 1 "/Users/alesimattia/Downloads/OLED_openWeather_calendar/OLED_openWeather_calendar.ino"
...
#line 51 "/Users/alesimattia/Downloads/OLED_openWeather_calendar/OLED_openWeather_calendar.ino"
String httpGETRequest(const char* serverName);
#line 79 "/Users/alesimattia/Downloads/OLED_openWeather_calendar/OLED_openWeather_calendar.ino"
void getWeatherData();
#line 112 "/Users/alesimattia/Downloads/OLED_openWeather_calendar/OLED_openWeather_calendar.ino"
void getForecast();
#line 135 "/Users/alesimattia/Downloads/OLED_openWeather_calendar/OLED_openWeather_calendar.ino"
void updateCurrentTime();
#line 146 "/Users/alesimattia/Downloads/OLED_openWeather_calendar/OLED_openWeather_calendar.ino"
void drawWeatherInfo();
#line 192 "/Users/alesimattia/Downloads/OLED_openWeather_calendar/OLED_openWeather_calendar.ino"
void drawForecast();
#line 231 "/Users/alesimattia/Downloads/OLED_openWeather_calendar/OLED_openWeather_calendar.ino"
void setup();
#line 278 "/Users/alesimattia/Downloads/OLED_openWeather_calendar/OLED_openWeather_calendar.ino"
void loop();
#line 51 "/Users/alesimattia/Downloads/OLED_openWeather_calendar/OLED_openWeather_calendar.ino"
String httpGETRequest(const char* serverName) {
...
void drawWeatherInfo() {
    // Placeholder readings from BME280
    float bmeTemp = 88.8;
    int bmeHum = 88;

    // Font per tutto tranne l'ora attuale
    u8g2.setFont(u8g2_font_spleen8x16_mr);
    
    // Temperatura BME280 in alto a sinistra
    int leftX = 2;
    u8g2.setCursor(leftX, 10);  // Modificato da 11 a 10
    u8g2.print("T:");
    u8g2.print(bmeTemp, 1);
    u8g2.print("C");

    // Umidità BME280 sotto la temperatura
    u8g2.setCursor(leftX, 22);  // Modificato da 24 a 22
    u8g2.print("H:");
    u8g2.print(bmeHum);
    u8g2.print("%");
    ...
    u8g2.drawXBMP(centerX - 24, 2, 8, 8, icon_arrow_up);  // Modificato y da 3 a 2
    u8g2.setCursor(centerX - 14, 10);  // Modificato da 11 a 10
    u8g2.print(sunriseTime);

    // Tramonto con icona a sinistra
    u8g2.drawXBMP(centerX - 24, 14, 8, 8, icon_arrow_down);  // Modificato y da 16 a 14
    u8g2.setCursor(centerX - 14, 22);  // Modificato da 24 a 22
    u8g2.print(sunsetTime);

    // Orario attuale in alto a destra con rettangolo bianco e testo nero
    int timeW = u8g2.getStrWidth(currentTime.c_str()) + 8;
    int timeH = 14;  // Modificato da 12 a 14 per adattarsi al font
    int timeX = 128 - (timeW + 2);
    int timeY = 2;
    u8g2.setDrawColor(1);
    u8g2.drawRBox(timeX, timeY, timeW, timeH, 4);
    u8g2.setDrawColor(0);
    u8g2.setCursor(timeX + 4, timeY + 12);  // Modificato offset Y da 10 a 12
...
void drawForecast() {
    ...
    int elemH = 32;
    int iconSize = 16;
    int baseY = 26;  // Modificato da 28 a 26

    u8g2.setFont(u8g2_font_spleen8x16_mr);

    // 3 previsioni future + previsione attuale
    for (int i = 0; i < 4; i++) {
        int x = i * elemW;
        ...
        u8g2.setCursor(x + (elemW - tempW) / 2, baseY + iconSize + 10);  // Modificato offset Y da 12 a 10

        // Orario sotto la temperatura con rettangolo bianco e testo nero
        String time = i < 3 ? forecastTimes[i] : currentTime;
        int timeW = u8g2.getStrWidth(time.c_str()) + 8;
        int timeH = 14;  // Modificato da 12 a 14
        int timeX = x + (elemW - timeW) / 2;
        int timeY = baseY + iconSize + 12;  // Modificato da 14 a 12
